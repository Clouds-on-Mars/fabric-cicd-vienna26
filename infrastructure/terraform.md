...
> [!NOTE]
> **Duration:** 30 minutes | **Difficulty:** Intermediate | [Next: Environment Setup →](../configuration/start.md)
...
| [Home](../README.md) | [Module 1: Environment Setup →](../configuration/start.md) |
|:---------------------|-----------------------------------------------------------:|
